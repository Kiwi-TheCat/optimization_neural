function [loss, grads, x_hat] = forward_backward_pass_per_batch(x, params, relu, relu_deriv)
%FORWARD_BACKWARD_PASS Perform forward and backward pass through a 3-layer autoencoder.
% the matrix multiplications make it faster than looping through each
% sample with forward_backward_pass
